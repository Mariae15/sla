...
parts_of_cake = []
parts_of_cake.append(["#CD853F", "#000000", 3, 30])
parts_of_cake.append(["#8B4513", "#000000", 3, 20])
parts_of_cake.append(["#CD853F", "#000000", 3, 60])

draw_layer_of_the_cake("#9400D3", "#000000", 3, -220, y_coordinate - 70, 400, 10)
...
draw_toppings_on_cake("#0000CD", "#000000", -120, y_coordinate - 60, 10)
draw_toppings_on_cake("#40E0D0", "#000000", -80, y_coordinate - 60, 10)
draw_toppings_on_cake("#32CD32", "#000000", 25, y_coordinate - 60, 10)
draw_toppings_on_cake("#9400D3", "#000000", 59, y_coordinate - 60, 10)
draw_toppings_on_cake("#FF69B4", "#000000", -135, y_coordinate - 80, 10)
draw_toppings_on_cake("#FF0000", "#000000", -135, y_coordinate - 100, 10)
draw_toppings_on_cake("#FF8C00", "#000000", -135, y_coordinate - 120, 10)
draw_toppings_on_cake("#FFFF00", "#000000", -80, y_coordinate - 80, 10)
draw_toppings_on_cake("#0000CD", "#000000", -65, y_coordinate - 110, 10)
draw_toppings_on_cake("#40E0D0", "#000000", -95, y_coordinate - 140, 10)
draw_toppings_on_cake("#32CD32", "#000000", 10, y_coordinate - 80, 10)
draw_toppings_on_cake("#9400D3", "#000000", -20, y_coordinate - 110, 10)
draw_toppings_on_cake("#FF69B4", "#000000", 35, y_coordinate - 140, 10)
draw_toppings_on_cake("#FF0000", "#000000", 75, y_coordinate - 80, 10)
draw_toppings_on_cake("#FF8C00", "#000000", 75, y_coordinate - 110, 10)
draw_toppings_on_cake("#FFFF00", "#000000", 75, y_coordinate - 140, 10)
